      ...
      <b-collapse id="collapse-1">
        <div class="col-12 collapsible-content">
          ...
          >
            ...
            class="img-fluid"
              provider="cloudinary"
              :src="webimages.filename.replace('https://res.cloudinary.com/mikkelraev/image/upload', '')"
              :alt="webimages.filename.replace('https://res.cloudinary.com/mikkelraev/image/upload', '')"
      ...
      <b-collapse id="collapse-2">
        <div class="col-12 collapsible-content">
          ...
          >
            ...
            class="img-fluid"
              provider="cloudinary"
              :src="designimages.filename.replace('https://res.cloudinary.com/mikkelraev/image/upload', '')"
              :alt="designimages.filename.replace('https://res.cloudinary.com/mikkelraev/image/upload', '')"
              sizes="xs:100vw sm:100vw md:100vw lg:25vw xl:25vw"
              :modifiers="{ 
                    format: 'webp',
            quality: 80,
